...
# 獲取漫畫數據
def DataRequest(totalpages,ComicLink,NameMerge):
    # 將路徑重新指向到創建的資料夾
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=64) as executor:
        ...
        for i in range(int(totalpages)):
            ...
            future = executor.submit(download, Picture_Name, Image_URL, headers)
...
def BasicSettings(Url):
    ...
    NameProcessing = bs4.select("h2")[0].text.split(" ")
    ...
    # 開始請求圖片
    DataRequest(totalpages,ComicLink,NameMerge)
